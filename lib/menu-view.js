  ...
  render () {
    return <div class='select-list'>
      ...
      <ol class='list-group' ref='list'>
        <li cscopeQuery='0'>Find this C symbol</li>
        <li cscopeQuery='1'>Find this function definition</li>
        <li cscopeQuery='2'>Find functions called by this function</li>
        <li cscopeQuery='3'>Find functions calling this function</li>
        <li cscopeQuery='4'>Find this text string</li>
        <li cscopeQuery='6'>Find this egrep pattern</li>
        <li cscopeQuery='7'>Find this file</li>
        <li cscopeQuery='8'>Find files #including this file</li>
      </ol>
    </div>
  }
